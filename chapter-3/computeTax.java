...
public class computeTax{
	public static void main(String[] args){
		...
		System.out.println("(0 status for single ,1 status for married,2 status forjoin familly,3 status for head of household)");
		...
		//get input from user to enter taxable income
		...
		//compute tax for head of household
			...
			if(income<=11950)
				...
				tax = 11950 * 0.10 + (45500-11950) * 0.15 +(117450-45500)*0.25 +(190200-117450)*0.28 + (372950-190200)* 0.33 + (income-372950)*0.38;
			
		}
		
			else {
				System.out.println("Error : invalied status");
				System.exit(1);
			}
